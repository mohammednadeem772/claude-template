...
function main() {
  ...
  log()
  log(`  ${c.bold}Commands (17):${c.reset}`)
  ...
  log(`  ${c.cyan}15.${c.reset} ${c.bold}/guard${c.reset}     — pre-deploy safety checks`)
  log(`  ${c.cyan}16.${c.reset} ${c.bold}/deploy${c.reset}    — deploy to staging or production`)
  log(`  ${c.cyan}17.${c.reset} ${c.bold}/document${c.reset}  — auto-generate documentation`)
  log(`  ${c.cyan}18.${c.reset} ${c.bold}/bootstrap${c.reset} — scaffold new component/screen/API`)
  log()
