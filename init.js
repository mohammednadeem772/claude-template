...
function main() {
  ...
  log(`  ${c.cyan}4.${c.reset}  ${c.bold}/ship${c.reset}      — full pipeline: build+test+review`)
  log(`  ${c.cyan}5.${c.reset}  ${c.bold}/optimize${c.reset}  — compress prompts, save tokens`)
  log(`  ${c.cyan}6.${c.reset}  ${c.bold}/context${c.reset}   — smart file loading`)
  log(`  ${c.cyan}7.${c.reset}  ${c.bold}/guard${c.reset}     — pre-deploy safety checks`)
  log(`  ${c.cyan}8.${c.reset}  ${c.bold}/feature${c.reset}   — build complete FE+BE feature`)
  log(`  ${c.cyan}9.${c.reset}  ${c.bold}/fix${c.reset}       — find and fix any bug`)
  log(`  ${c.cyan}10.${c.reset} ${c.bold}/review${c.reset}    — code review with severity`)
  log(`  ${c.cyan}11.${c.reset} ${c.bold}/test${c.reset}      — write tests for any file`)
  log(`  ${c.cyan}12.${c.reset} ${c.bold}/refactor${c.reset}  — clean up and improve code`)
  log()
